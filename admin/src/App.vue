  ...
  <el-container class="main">
    ...
    <el-container>
      ...
      <el-aside class="main-left">
        <el-menu class="el-menu-vertical-demo" :collapse="isCollapse" :unique-opened="true" :router="true" text-color="#fff" background-color="#001529" active-text-color="#2d8cf0">
          <!--collapse-->
      ...
      <el-container class="main-right">
        ...
        <!--content -->
        <el-main class="main-content" v-loading="pageLoading"
...
import ModifyPassword from './pages/user/ModifyPassword.vue'
